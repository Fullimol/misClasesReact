    ...
    return (
        <div className="card container" style={{ width: "18rem" }}>
            ...
            <div className="card-body text-center">
                ...
                {!contador || <Counter botonAgregar producto={{ img, titulo, descripcion, id, precio }} />} {/* le paso por la prop "producto" del <Counter/> cada valor que le puse a la props <Card/> en el HOME */}
